...
const LoginPage = () => {
    ...
    return ( 
        <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50'>
            ...
            <div className='absolute inset-0 bg-[radial-gradient(#e5e5eb_1px, transparent_1px)] bg-size-[16px_16px] opacity-300'></div>
                    ...
                    <div className='bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
                        ...
                        <div className='text-center mb-10'>
                            ...
                            <div className='space-y-5'>
                                ...
                                >
                                  <span className='relative z-19 flex items-center justify-center gap-2'>
                                    {loading ? (
                                        <>

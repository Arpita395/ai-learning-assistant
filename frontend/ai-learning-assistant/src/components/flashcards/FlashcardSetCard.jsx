            ...
            <div className='space-y-4'>
                ...
                <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1 min-w-0'>
                        <h3 className='text-base font-semibol text-slate-900 line-clamp-2 mb-1' title= {flashcardSet?.documenId?.title}>
                ...
                <div className='flex items-center gap-3 pt-2'>
                    ...
                    {reviewedCount>0 && (
                        <div className='flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 border border-emerald-200 rounded-lg'>
                            <TrendingUp className='w-3.5 h-3.5 text-emerald-700' strokeWidth={2.5} />
                ...
                {totalCards >0 && (
                    <div className='space-y-2'>
                        <div className='flex items-center justify-between'>
                            <span className='text-xs fomt-medium text-slate-600'>
                                Progress
                            </span>
                        ...
                        <div className='relative h-2 bg-slate-100 rounded-full overflow-hidden'>
                            <div 
                                className='absolute inset-y-0 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-out'

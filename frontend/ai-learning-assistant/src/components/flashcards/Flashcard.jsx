                ...
                <div className='flex items-start justify-between'>
                    ...
                    <button
                        ...
                        className= {`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                            flashcard.isStarred  
                                ? 'bg-linear-to-br from bg-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-500/25'
                    ...
                    <button
                        ...
                        className= {`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                            flashcard.isStarred  
                                ...
                                : 'bg-white/20 backdrop-blur-sm text-white/70 hover:bg-white/30 hover:text-white border-white/20'
                        }`}
                    >
                        <Star 
                            className='w-4 h-4'

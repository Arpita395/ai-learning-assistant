        ...
        <div className='bg-white border-neutral-200 rounded-lg p-6'>
            ...
            >
                <form onSubmit={handleGenerateQuiz} className='space-y-4'>
                    <div>
                        <label className='block text-xs font-medium text-meutral-700 mb-1.5'>
                            Number of Questions
                        </label>
                        <input
                            type='number'
                            ...
                            min='1'
                            required
                            className='border border-neutral-200 rounded-lg w-full h-9 px-3 bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent'
                        />
                    </div>
